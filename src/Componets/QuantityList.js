              ...
              return (
                <TableBody key={user._id}>
                  <TableRow>
                    ...
                    <TableCell align="center">{user.StartQuantity}</TableCell>
                    <TableCell align="center">{user.MiddleQuantity}</TableCell>
                    <TableCell align="center">{user.EndQuantity}</TableCell>
